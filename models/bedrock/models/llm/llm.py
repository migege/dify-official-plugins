...
class BedrockLargeLanguageModel(LargeLanguageModel):
    ...
    CONVERSE_API_ENABLED_MODEL_INFO = [
        ...
        {"prefix": "eu.anthropic.claude-opus-4", "support_system_prompts": True, "support_tool_use": True},
        {"prefix": "anthropic.claude-opus-4", "support_system_prompts": True, "support_tool_use": True},
        {"prefix": "us.anthropic.claude-sonnet-4", "support_system_prompts": True, "support_tool_use": True},
        {"prefix": "eu.anthropic.claude-sonnet-4", "support_system_prompts": True, "support_tool_use": True},
        {"prefix": "anthropic.claude-sonnet-4", "support_system_prompts": True, "support_tool_use": True},
